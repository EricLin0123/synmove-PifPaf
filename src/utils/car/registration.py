...
def register_car_model(point3d_list: list[list], model_points: np.ndarray, is_scaled: bool = False,
    ...
    # points means one car
    # point3d_list is a list of 3D points for multiple cars
    for points in point3d_list:
        registered_points = car_registration_ransac(
            points, model_points, num_iter=num_iter, is_scaled=is_scaled, threshold=threshold)
